  ...
  <div class="par-trigger">
    <div class="par-trigger-inner">
      ...
      <div class="par-chips">
        ...
        <button class="par-chip" data-prof="3">금속기와 부식</button>
        <button class="par-chip" data-prof="4">외벽 균열</button>
        <button class="par-chip" data-prof="6">지하 곰팡이</button>
...
var SURFS=[{id:'roof-slab',ic:'🏢',name:'옥상 슬라브',desc:'콘크리트 평지붕'},{id:'roof-shingle',ic:'🏠',name:'아스팔트 슁글 지붕',desc:'경사형 — 미국식 마감재'},{id:'roof-metal',ic:'⛩️',name:'금속기와·칼라강판',desc:'경사형 금속 지붕'},{id:'drain',ic:'💧',name:'옥상 배수구',desc:'드레인, 빗물받이'},{id:'wall',ic:'🧱',name:'외벽',desc:'균열, 도장, 백화'},{id:'parking',ic:'🅿️',name:'지하 주차장',desc:'바닥, 벽체, 천장'},{id:'balcony',ic:'🏡',name:'발코니·베란다',desc:'바닥, 벽, 배수'},{id:'road',ic:'🛣️',name:'단지내 도로',desc:'주차장, 도로 균열·포트홀'},{id:'underg',ic:'🕳️',name:'지하실·수조',desc:'배면 누수, 곰팡이'},{id:'etc',ic:'📐',name:'기타',desc:'분류가 어려운 경우'}];
...
var KEYWORDS={drain:['배수','드레인','하수구','빗물받이','배수구'],'roof-slab':['옥상','슬라브','평지붕','콘크리트','잔금'],'roof-shingle':['옥상','지붕','슁글','쉬글','아스팔트','경사','목조','떨어'],'roof-metal':['옥상','지붕','금속기와','기와','칼라강판','징크','맞물림','강판'],wall:['외벽','벽','균열','크랙','도색','도장','백화','재도장'],parking:['주차','지하주차','바닥','에폭시','박리'],underg:['지하실','지하','곰팡이','배면','수조','스며'],road:['도로','아스팔트','포트홀','단지','구멍'],balcony:['발코니','베란다']};
var SUGGESTIONS=[
{profIdx:0,title:'옥상 배수구 누수',desc:'배수구 부식·정체수 → 천장 누수',kw:['옥상','배수','드레인','하수','빗물','빗물받이','배수구','물샘','새요','누수'],img:'https://placehold.co/120x120/F97316/fff?text=배수구'},
{profIdx:2,title:'옥상 슬라브 누수',desc:'콘크리트 평지붕 — 중성화·균열',kw:['옥상','슬라브','평지붕','콘크리트','잔금','누수','크랙','균열','갈라'],img:'https://placehold.co/120x120/F97316/fff?text=슬라브'},
{profIdx:1,title:'아스팔트 슁글 떨어짐',desc:'경사형 지붕 — 강풍 탈락·추락 위험',kw:['옥상','지붕','슁글','쉬글','아스팔트','경사','떨어','탈락','강풍','날아','목조'],img:'https://placehold.co/120x120/EA580C/fff?text=슁글'},
{profIdx:3,title:'금속기와·칼라강판 부식',desc:'경사형 금속 지붕 — 맞물림 풀림·추락 위험',kw:['옥상','지붕','금속기와','기와','칼라강판','징크','맞물림','강판','부식'],img:'https://placehold.co/120x120/EA580C/fff?text=금속기와'},
{profIdx:4,title:'외벽 균열·재도장',desc:'미세 균열·도장 박리·백화',kw:['외벽','벽','균열','크랙','도색','도장','백화','재도장','박리'],img:'https://placehold.co/120x120/F97316/fff?text=외벽'},
{profIdx:5,title:'지하주차장 박리',desc:'에폭시 노후·차량 마모',kw:['주차','지하주차','바닥','에폭시','박리','마모','벗겨'],img:'https://placehold.co/120x120/F97316/fff?text=주차장'},
{profIdx:6,title:'지하실 곰팡이·누수',desc:'배면 침투수·표면 박리',kw:['지하','지하실','곰팡이','배면','수조','스며','곰팽이'],img:'https://placehold.co/120x120/EA580C/fff?text=지하'},
{profIdx:7,title:'단지 도로·아스팔트',desc:'균열·포트홀·층간 분리',kw:['도로','아스팔트','포트홀','단지','구멍','갈라'],img:'https://placehold.co/120x120/F97316/fff?text=도로'},
{profIdx:8,title:'그 외 종합 진단',desc:'전문가 방문·맞춤 패키지',kw:[],img:'https://placehold.co/120x120/9CA3AF/fff?text=종합'}
];
...
`;
  ...
  const DEFAULT_PAGES = () => ([
    { id: 'main', name: '메인 페이지', file: 'index.html', sections: [
      ...
      mkSec('AI 맞춤 자재추천', SEED_AI_RECOMMEND_HTML, 'POUR 길잡이 — 옥상 형태 분리(슬라브/슁글/금속기와) + 자동완성 정확도 개선 (v6)', 'wip'),
