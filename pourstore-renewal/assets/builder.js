  ...
  <div class="par-trigger">
    <div class="par-trigger-inner">
      ...
      <div class="par-chips">
        ...
        <button class="par-chip" data-prof="4">칼라강판·징크</button>
        <button class="par-chip" data-prof="5">외벽 균열</button>
        <button class="par-chip" data-prof="7">지하 곰팡이</button>
...
var KEYWORDS={drain:['배수','드레인','하수구','빗물받이','배수구'],'roof-slab':['옥상','슬라브','평지붕','콘크리트','잔금'],'roof-shingle':['옥상','지붕','슁글','쉬글','아스팔트','경사','목조','떨어'],'roof-metal':['옥상','지붕','금속기와','기와','맞물림'],'roof-color-steel':['옥상','지붕','칼라강판','강판','징크','징크판넬','판넬','색바램','녹','부식'],wall:['외벽','벽','균열','크랙','도색','도장','백화','재도장'],parking:['주차','지하주차','바닥','에폭시','박리'],underg:['지하실','지하','곰팡이','배면','수조','스며'],road:['도로','아스팔트','포트홀','단지','구멍'],balcony:['발코니','베란다']};
var SUGGESTIONS=[
...
{profIdx:3,title:'금속기와 부식·맞물림 풀림',desc:'경사형 금속기와 — 추락 위험',kw:['옥상','지붕','금속기와','기와','맞물림','부식','떨어'],img:'https://placehold.co/120x120/EA580C/fff?text=금속기와'},
{profIdx:4,title:'칼라강판·징크판넬 노후',desc:'색상 열화·녹·부식 — 코팅 재시공',kw:['옥상','지붕','외장','칼라강판','강판','징크','징크판넬','판넬','색바램','녹','부식','코팅'],img:'https://placehold.co/120x120/EA580C/fff?text=칼라강판'},
{profIdx:5,title:'외벽 균열·재도장',desc:'미세 균열·도장 박리·백화',kw:['외벽','벽','균열','크랙','도색','도장','백화','재도장','박리'],img:'https://placehold.co/120x120/F97316/fff?text=외벽'},
{profIdx:6,title:'지하주차장 박리',desc:'에폭시 노후·차량 마모',kw:['주차','지하주차','바닥','에폭시','박리','마모','벗겨'],img:'https://placehold.co/120x120/F97316/fff?text=주차장'},
{profIdx:7,title:'지하실 곰팡이·누수',desc:'배면 침투수·표면 박리',kw:['지하','지하실','곰팡이','배면','수조','스며','곰팽이'],img:'https://placehold.co/120x120/EA580C/fff?text=지하'},
{profIdx:8,title:'단지 도로·아스팔트',desc:'균열·포트홀·층간 분리',kw:['도로','아스팔트','포트홀','단지','구멍','갈라'],img:'https://placehold.co/120x120/F97316/fff?text=도로'},
{profIdx:9,title:'그 외 종합 진단',desc:'전문가 방문·맞춤 패키지',kw:[],img:'https://placehold.co/120x120/9CA3AF/fff?text=종합'}
];
...
`;
  ...
  const DEFAULT_PAGES = () => ([
    { id: 'main', name: '메인 페이지', file: 'index.html', sections: [
      ...
      mkSec('AI 맞춤 자재추천', SEED_AI_RECOMMEND_HTML, 'POUR 길잡이 — 옥상 형태 5종 분리(슬라브/슁글/금속기와/칼라강판·징크/배수구) (v7)', 'wip'),
