/**
 * 상품상세 Q&A
 * ※ 보안문자(자동등록방지) + 새로고침(captcha_refresh) 이미 적용된 표준본.
 *   스팸 자동등록 차단의 핵심은 (A) 게시판관리에서 '자동등록방지' 사용 ON,
 *   (B) 글쓰기(write.html) 폼의 보안문자 블록 입니다. 이 파일(댓글 폼)은 이미 캡차 포함.
 */
$(function(){
